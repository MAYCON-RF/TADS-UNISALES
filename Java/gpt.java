            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    for (int i = 0; i < totalDeAlunos; i++) {
                        System.out.println("Aluno: " + nomesDosAlunos[i] + "\n      Média das notas: " + mediasDosAlunos[i]);
                        if (situacao[i] == 1) {
                ...
                case 0:
                    ...
                    break;
                default:
                    System.out.println("Opção inválida. Digite um número de 1 a 4 e 0 para sair.");
                    break;
            }
